<html>
<head>
  <link rel="stylesheet" href="website/css/time_of_planting.css">
  <script>
...
<body>
  ...
  <table border="1" width="100%">
    ...
    <?php
      ...
      $sql = "SELECT id, crop_id, start_month, end_month FROM time_of_planting";
  ...
  <div id="modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background-color:rgba(0,0,0,0.5);">
    <div style="background-color:white; margin:10% auto; padding:20px; width:300px;">
      ...
      <form action="/update?u=time_of_planting" method="post">
